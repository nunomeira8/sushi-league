...
export const translations = {
  en: {
    ...
    imDone: 'I surrender to the sushi 🍣',
    giveUp: 'I’m Done Eating',
    giveUpTitle: 'Done eating already? 🍣',
    giveUpDescription: 'Your score is safe! You’ll simply wait for the remaining players.',
    yesGiveUp: 'Yes, I am done',
    keepEating: 'No, I can still eat',
    finishingGame: 'Finishing...',
    waitingTitle: 'The sushi battlefield continues...',
    stillEating: 'Still eating',
    finishedEating: 'Already surrendered',
    finishedTitle: 'The sushi battle is over',
    winnerReveal: 'Prepare yourselves for the best part... let’s discover the winner.',
    survivedFor: 'Survived for',
    survivedEntireTime: 'Survived the entire battle',
  ...
  pt: {
    ...
    imDone: 'Já não entra mais sushi 🍣',
    giveUp: 'Terminei de Comer',
    giveUpTitle: 'Já não consegues comer mais? 🍣',
    giveUpDescription: 'Os teus pontos ficam guardados! Vais apenas esperar pelos restantes jogadores.',
    yesGiveUp: 'Sim, já chega',
    keepEating: 'Não, ainda aguento',
    finishingGame: 'A terminar...',
    waitingTitle: 'A batalha do sushi continua...',
    stillEating: 'Ainda a comer',
    finishedEating: 'Já desistiu',
    finishedTitle: 'A batalha do sushi terminou',
    winnerReveal: 'Preparem-se para a melhor parte... vamos descobrir o vencedor.',
    survivedFor: 'Aguentou durante',
    survivedEntireTime: 'Sobreviveu à batalha inteira',
  ...
  fr: {
    ...
    minutesLabel: 'minutes',
    imDone: 'Je ne peux plus manger 🍣',
    giveUp: 'J’ai Fini de Manger',
    giveUpTitle: 'Tu n’en peux plus ? 🍣',
    giveUpDescription: 'Ton score est sauvegardé ! Tu attendras simplement les autres joueurs.',
    yesGiveUp: 'Oui, j’abandonne',
    keepEating: 'Non, je continue',
    finishingGame: 'Fin du jeu...',
    waitingTitle: 'La bataille du sushi continue...',
    stillEating: 'Encore en train de manger',
    finishedEating: 'A déjà abandonné',
    finishedTitle: 'La bataille du sushi est terminée',
    winnerReveal: 'Préparez-vous pour le meilleur moment... découvrons le gagnant.',
    survivedFor: 'A survécu pendant',
    survivedEntireTime: 'A survécu à toute la bataille',
